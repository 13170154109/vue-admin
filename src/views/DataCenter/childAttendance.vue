<template>
  <div class="childAttendance">
    <PageNav :slider="slider" :openMenu="openMenu">
      <el-main>
        <!-- <router-view></router-view> -->
        <div class="page-childAttendance">
          <div class="head-tab--nav">
            <div class="head-tab">
              <router-link tag="span" :to="{path: '/DataCenter/childAttendance'}">幼儿考勤</router-link>
            </div>
            <div class="exchange">
              <div class="head-nav">
                <span>统计中心</span>
                <span>></span>
                <span class="c-normal">幼儿考勤</span>
              </div>
            </div>
          </div>
          <div class="top-tab content">
            ...
            <el-row>
              <el-col :span="6" v-for="item in TabOptions" :key="item.value">
          ...
          <div class="content financial-compared clearFloat">
            ...
            <div class="cnavas-schart compared-table">
              <el-table :data="tableData" style="width: 100%" :span-method="arraySpanMethod">
                ...
                <el-table-column prop="sickLeaveRate" sortable label="病假率">
                  <template slot-scope="scope">
                    <div
                      :class="scope.row.isSerious==true? 'font-red' :''"
                    >{{ scope.row.sickLeaveRate }}</div>
                  </template>
                </el-table-column>
        ...
        series: [
          {
            ...
            data: [
              ...
              {
                value: 434,
                itemStyle: { color: "#20a8d8" },
                name: "总病假人数"
              },
              {
                value: 234,
                itemStyle: { color: "#f8cb00" },
                name: "总事假人数"
              }
            ],
            itemStyle: {
